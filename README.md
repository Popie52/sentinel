...
Independent test executables are built for CLI parsing and TCP connectivity and registered with CTest.
...
Sentinel is being built with a focus on understanding networking fundamentals rather than relying on high-level networking libraries.
...
The goal of Sentinel is to build a networking tool incrementally while developing a deeper understanding of the underlying operating-system and networking primitives.
...
This approach keeps the project focused on learning how TCP connections, sockets, timeouts, file descriptors, and asynchronous I/O work at a lower level.
